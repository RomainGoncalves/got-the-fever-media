...
<form action="/" method="get" accept-charset="utf-8">
	...
	<div class="form-section clearfix">
        <label for="heading-margin-top">Margin Top<br  /><small>Ex: 20px</small></label>
        <input type="text" name="heading-margin-top" value="" id="heading-margin-top" />
    </div>
  	<div class="form-section clearfix">
        <label for="heading-margin-bottom">Margin Bottom<br  /><small>Ex: 20px</small></label>
