 ...
 * Based off the work of João Araújo - http://themeforest.net/user/unisphere
 */

// Constants for the theme name, folder and remote XML url
define( 'NOTIFIER_THEME_NAME', 'WP Form' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'form' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://wp.contempographicdesign.com/wp_form/changelog/notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
