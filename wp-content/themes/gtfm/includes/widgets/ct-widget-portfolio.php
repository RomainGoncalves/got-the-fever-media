...
class ct_Portfolio extends WP_Widget {
   ...
   function widget($args, $instance) {  
	...
	?>
        ...
        <ul class="right">
            <li><a class="prev port-item" href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/icons/l-arrow.png" /></a></li>
            <li><a class="next port-item" href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/icons/r-arrow.png" /></a></li>
        </ul>
