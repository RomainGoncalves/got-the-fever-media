	...
	function block($instance) {
		...
		switch($horizontal_line) {
			case 'none':
				break;
			case 'single':
				echo '<hr class="aq-block-clear aq-block-hr-single" style="border-color:'.$line_color.';"/>';
				break;
			case 'double':
				echo '<hr class="aq-block-clear aq-block-hr-double" style="border-color:'.$line_color.';"/>';
				echo '<hr class="aq-block-clear aq-block-hr-single" style="border-color:'.$line_color.';"/>';
				break;
			case 'image':
